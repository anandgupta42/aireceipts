...
// four data/prices tables at ~60 KB and the tarball at ~621 KB in CI. SPEC-0095
// (cited aliases, comparison candidates, the unpriced-model line) and SPEC-0094
// (statusline heartbeat, parse-failure shapes, agentType seam) added runtime
// code and cited price data and put it at ~665 KB. Keep narrow headroom so
// normal runtime growth fits while a real regression (sourcemaps back, a stray
// directory) still trips the release gate.
export const MAX_TARBALL_FILES = 80;
export const MAX_UNPACKED_KB = 700;
